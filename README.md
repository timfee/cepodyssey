...
- **Resilient Server Actions**: All backend logic resides in Server Actions (`app/actions/`). These actions are designed to **never throw exceptions** to the client. Instead, they always return a structured result object, ensuring predictable communication between the client and server.
